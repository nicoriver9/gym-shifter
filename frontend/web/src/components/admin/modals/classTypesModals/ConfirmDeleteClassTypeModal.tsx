...
const ConfirmDeleteClassTypeModal = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center transition-opacity duration-300 ${visible ? "bg-black/60 backdrop-blur-sm" : "bg-black/0"
        }`}
    >
      <div
      ...
      >
        ...
        <p className="text-center text-sm md:text-base mb-1">
          ¿Estás seguro de que deseas eliminar la clase <strong>{className}</strong>?
        </p>
